...
# Copyright 2025 HuggingFace Inc. and the LlamaFactory team.
# Extended to support lambda_dpo while preserving existing logic
...
class CustomDPOTrainer(DPOTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        self.use_ref_model = finetuning_args.use_ref_model
    ...
    @override
    def get_batch_loss_metrics(self, model: "PreTrainedModel", batch: dict[str, "torch.Tensor"], train_eval: Literal["train", "eval"] = "train"):
        metrics = {}
        policy_chosen_logps, policy_rejected_logps, policy_chosen_logits, policy_rejected_logits, policy_chosen_logps_avg = self.concatenated_forward(model, batch)
